 ...
 */
final class Version20230219143111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, list_order VARCHAR(4) NOT NULL, show_on_home TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, sub_category_id INT DEFAULT NULL, product_type_id INT NOT NULL, brand_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, buy_price VARCHAR(10) DEFAULT NULL, catalog_price VARCHAR(10) DEFAULT NULL, selling_price VARCHAR(10) NOT NULL, visibility TINYINT(1) NOT NULL, in_stock TINYINT(1) NOT NULL, in_stock_quantity VARCHAR(5) NOT NULL, product_data JSON DEFAULT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), INDEX IDX_D34A04ADF7BFE87C (sub_category_id), INDEX IDX_D34A04AD14959723 (product_type_id), INDEX IDX_D34A04AD44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, type_data JSON DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
